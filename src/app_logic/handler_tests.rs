...
mod handler_tests {
    ...
    impl MockProfileRuntimeData {
        ...
        #[allow(dead_code)]
        fn set_get_node_attributes_for_path_result(
            &mut self,
            result: Option<(SelectionState, bool)>,
        ) {
    ...
    fn test_profile_load_updates_archive_status_via_mock_archiver() {
        ...
        mock_file_system_scanner_arc
            .set_scan_directory_result(&root_folder_for_profile, Ok(vec![]));
        {
            mock_app_session_mutexed
                .lock()
                .unwrap()
    ...
    fn test_is_tree_item_new_for_file_and_folder() {
        ...
        // Populate mock session data
        {
            ...
            app_data
                .set_does_path_or_descendants_contain_new_file_result(&folder_with_new_path, true);
            app_data
                .set_does_path_or_descendants_contain_new_file_result(&folder_no_new_path, false);
